...
LiftingAgv::LiftingAgv(const AgvType& _type,const AId_t& _id,
                         ...
                         QObject *parent)
    : SubmersibleAgv(_type,_id,_bClient,_peerAddr,_peerPort,_localAddr,_localPort,parent)
{

}

std::string LiftingAgv::GetActionName() const
{
